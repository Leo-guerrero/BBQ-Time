...
if (instance_number(Enemy) < max_enemies && t_accum >= spawn_interval_sec) {
    ...
    if (ok) {
        ...
        if (instance_exists(po_bbq)) e.target = instance_find(po_bbq, 0);
    }
}
